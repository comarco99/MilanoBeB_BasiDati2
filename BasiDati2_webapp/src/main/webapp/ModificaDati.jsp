...
<%Listing l= (Listing) request.getAttribute("update");%>
...
<center><h2>AGGIORNA I DATI DI UN AIRB&B</h2></center>
<div id="mainModifica">
  <form action="./modificaListing" method="post" id="formModifica">
    <label>Id AirB&B: </label><br>
    <input type="text" id="idAir" name="idAir" value="<%=l.getListingId()%>"><br>
    <label>Nome AirB&B:</label><br>
    <input type="text" id="nome" name="nome" value="<%=l.getName()%>"><br>
    <label>Nome host:</label><br>
    <input type="text" id="nomeHost" name="nomeHost" value="<%=l.getHostName()%>"><br>
    <label>Prezzo:</label><br>
    <input type="text" id="prezzoAir" name="prezzoAir" value="<%=l.getPrice()%>"><br>
    <label>Latitudine:</label><br>
    <input type="text" id="latitudine" name="latitudine" value="<%=l.getLatitude()%>"><br>
    <label>Longitudine:</label><br>
    <input type="text" id="longitudine" name="longitudine" value="<%=l.getLongitude()%>"><br>
    <label>Quartiere AirB&B:</label><br>
    <select id="quartiere" name="quartiere" class="quartieriClass">
      <option value="<%=l.getNeighbourhood()%>"><%=l.getNeighbourhood()%></option>
    ...
    <select id ="room" name="room">
      <option value="<%=l.getRoomType()%>"><%=l.getRoomType()%></option>
